  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: new Center(
        ...
        new SizedBox(height: spacerBox),
        new Padding(
            padding: EdgeInsets.all(stdPadding),
            child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                      colors: [babyPink, babyBlue, babyBlue, babyPink]),
                  borderRadius:
                      BorderRadius.all(Radius.circular(headingFontSize)),
                ),
                child: new Center(
                    child: new Column(children: <Widget>[
                  new Padding(
                      padding: EdgeInsets.all(stdPadding),
                      child: new Text('$dataMessage:',
                          style: new TextStyle(
                              color: babyBlack,
                          ...
                          decoration: new InputDecoration(
                            ...
                            enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color: babyWhite, width: stdLineDimension),
                            ),
                      ...
                      onPressed: () {
                        ...
                        if (input == null || input == '') {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      Output(data: inputController.text)));
                        }
                      })))),
      bottomNavigationBar: new BottomAppBar(
        ...
        child: Padding(
          padding: EdgeInsets.all(paddingTwo * 2.4),
        ),
      ),
    );
  }
